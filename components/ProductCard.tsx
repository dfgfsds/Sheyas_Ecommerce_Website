        ...
        <div className="group cursor-pointer">
            ...
            <div className="space-y-1">
                {product?.status ? (
                    ...
                    <h3 className="md:text-lg text-base font-semibold text-gray-500 capitalize truncate">
                        {product.name}
                    </h3>
                )}
                ...
                {product?.status ? (
                    ...
                    <button
                        disabled
                        className="w-full mt-3 border border-gray-300 bg-gray-100 text-gray-500 md:py-3 py-1.5 rounded-full text-sm md:text-base font-bold cursor-not-allowed"
                    >
                        Unavailable
                    </button>
                )}
