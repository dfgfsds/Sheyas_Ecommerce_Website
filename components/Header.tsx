...
export default function Header() {
    ...
    return (
        <header className="w-full sticky top-0 z-[100] bg-white">
            ...
            {isSearchOpen && (
                <div ref={searchRef} className="absolute top-full left-0 w-full bg-white border-b border-gray-100 py-4 px-4 shadow-2xl z-[120] animate-in slide-in-from-top duration-300">
                    <div className="container mx-auto max-w-2xl relative">
                        ...
                        {searchQuery.trim().length > 1 && (
                            <div className="mt-4 bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-xl">
