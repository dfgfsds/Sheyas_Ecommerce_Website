    ...
    return (
        <section className="max-w-[1440px] mx-auto px-4 sm:px-12 pt-10 pb-[75px] md:pt-14 md:pb-24 overflow-hidden">
            ...
            >
                ...
                >
                    <h2 className="text-2xl sm:text-4xl font-serif text-[#000000] mb-4 italic tracking-wide">
                        {title}
                    </h2>
                    <p className="text-xs sm:text-base text-gray-800 leading-relaxed tracking-wide mb-6 max-w-md italic">
                        {description}
                    </p>
