        ...
        <main className="min-h-screen bg-[#fcfcfc] py-12 px-6 sm:px-12 font-sans text-gray-900">
            <div className="max-w-4xl mx-auto">
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                                    ...
                                    <div className="flex items-center justify-between sm:justify-end gap-12">
                                        <div className="text-right">
                                            ...
                                            <p className="font-bold text-[#000000]">{order.total}</p>
                                        </div>

                                        <div className="flex items-center gap-4">
                                            <span className={`px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider ${order.status === 'Delivered'
                ...
                <div className="mt-12 flex justify-center gap-2">
                    <button className="w-10 h-10 rounded-full border border-[#000000] bg-[#000000] text-white text-sm font-bold">1</button>
